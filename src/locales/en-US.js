export default {
  ...
  tokenList: {
    ...
    exportMessage: 'About to export {total} token(s)',
    exportCount: 'Export Count',
    exportAll: 'Export All',
    exportAndDelete: 'Export and Delete',
    exportAndDeleteWarning: '⚠️ Warning: These tokens will be deleted after export. This action cannot be undone!',
    willExport: 'Will Export',
    willDelete: 'Will Delete',
    confirmExport: 'Confirm Export',
    exporting: 'Exporting...',
    exportSuccess: 'Successfully exported {count} token(s)',
    ...
    filterBindCard: 'Bound Card',
    filterUnbindCard: 'Unbound Card',
    balanceFilter: 'Balance Filter',
    balanceFilterTitle: 'Filter by Balance Range',
    balanceFilterMin: 'Minimum Balance',
    balanceFilterMax: 'Maximum Balance',
    balanceFilterMinPlaceholder: 'e.g., 100',
    balanceFilterMaxPlaceholder: 'e.g., 1000',
    balanceFilterApply: 'Apply Filter',
    balanceFilterClear: 'Clear Filter',
    balanceFilterApplied: 'Balance filter applied',
    balanceFilterCleared: 'Balance filter cleared',
    balanceFilterInvalid: 'Minimum balance cannot be greater than maximum balance',
    quickFilter: 'Click to quick filter',
    copyEmails: 'Copy Emails',
    emailsCopied: 'Copied {count} email(s) to clipboard',
    noEmailsToCopy: 'No emails to copy',
    noEmailsFound: 'No email information found in filtered results'
  },
  tokenCard: {
    banned: 'Banned',
    active: 'Active',
    ...
    copyAppSession: 'Copy App Session',
    ...
    openPayment: 'Open Payment Method',
    alreadyBindCard: 'Card Already Bound',
    paymentMethodTitle: 'Payment Method Link',
  ...
  messages: {
    ...
    authSessionRequired: 'Auth Session is required to fetch payment method link',
    authSessionRequiredForPayment: 'This account needs to be imported via Session to fetch payment method link',
    authSessionRequiredForAppSession: 'Auth Session is required to fetch App Session',
    fetchingPaymentLink: 'Fetching payment method link...',
    fetchingAppSession: 'Fetching App Session...',
    paymentLinkFetched: 'Payment method link fetched successfully!',
    paymentLinkFetchFailed: 'Failed to fetch payment method link',
    alreadyBindCard: 'This account already has a payment method bound',
    appSessionCopied: 'App Session copied to clipboard!',
    copyAppSessionFailed: 'Failed to copy App Session',
    appSessionFetchFailed: 'Failed to fetch App Session',
    ...
    vimConfigSuccess: 'Vim configuration written, please restart Vim to apply',
    vimConfigFailed: 'Vim configuration failed',
    auggieConfigSuccess: 'Auggie configuration written, please restart Auggie to apply',
    auggieConfigFailed: 'Auggie configuration failed',
  ...
  teamManager: {
    ...
    noTeam: 'This account has no team information',
    canStillInvite: 'But you can still send invitations',
    ...
    confirmRemove: 'Are you sure you want to remove {email}?',
    confirmCancel: 'Are you sure you want to cancel the invitation to {email}?'
  }
}
