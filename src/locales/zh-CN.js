export default {
  ...
  tokenList: {
    ...
    refreshCurrentPageDesc: '只刷新当前分页显示的账号状态',
    refreshAll: '刷新全部',
    refreshAllDesc: '刷新所有账号的状态',
    selectRefreshMode: '请选择刷新模式',
    filterAbnormal: '只看异常',
    filterAll: '全部',
    filterNormal: '正常',
    filterBindCard: '已绑卡',
    filterUnbindCard: '未绑卡',
    quickFilter: '点击快速筛选',
    statsTotal: '总账号数',
    statsNormal: '正常账号',
    statsBanned: '异常账号',
    exportTitle: '导出Token',
    exportMessage: '即将导出 {total} 个Token',
    exportCount: '导出数量',
    exportAll: '全部导出',
    exportAndDelete: '导出后删除',
    exportAndDeleteWarning: '⚠️ 警告：导出后将删除这些Token，此操作不可撤销！',
    willExport: '将导出',
    willDelete: '将删除',
    confirmExport: '确认导出',
    exporting: '导出中...',
    exportSuccess: '成功导出 {count} 个Token',
    downloadedTo: '已下载到',
    exportFailed: '导出失败',
    noTokensToExport: '没有可导出的Token',
    balanceFilter: '余额筛选',
    balanceFilterTitle: '按余额范围筛选',
    balanceFilterMin: '最小余额',
    balanceFilterMax: '最大余额',
    balanceFilterMinPlaceholder: '例如：100',
    balanceFilterMaxPlaceholder: '例如：1000',
    balanceFilterApply: '应用筛选',
    balanceFilterClear: '清除筛选',
    balanceFilterApplied: '余额筛选已应用',
    balanceFilterCleared: '余额筛选已清除',
    balanceFilterInvalid: '最小余额不能大于最大余额',
    copyEmails: '复制邮箱',
    emailsCopied: '已复制 {count} 个邮箱到剪贴板',
    noEmailsToCopy: '没有可复制的邮箱',
    noEmailsFound: '筛选结果中没有邮箱信息'
  },
  tokenCard: {
    banned: '已封禁',
    active: '正常',
  ...
  messages: {
    ...
    authSessionRequired: '需要 Auth Session 才能获取绑卡链接',
    authSessionRequiredForPayment: '此账号需要通过 Session 导入才能获取绑卡链接',
    authSessionRequiredForAppSession: '需要 Auth Session 才能获取 App Session',
    fetchingPaymentLink: '正在获取绑卡链接...',
    fetchingAppSession: '正在获取 App Session...',
    paymentLinkFetched: '绑卡链接获取成功!',
    paymentLinkFetchFailed: '获取绑卡链接失败',
    alreadyBindCard: '该账号已绑卡',
    appSessionCopied: 'App Session 已复制到剪贴板!',
    copyAppSessionFailed: '复制 App Session 失败',
    appSessionFetchFailed: '获取 App Session 失败',
  ...
  teamManager: {
    ...
    joined: '加入时间',
    removeMember: '移除成员',
    pendingInvitations: '待入团邀请',
    invitedAt: '邀请时间',
    pending: '待接受',
    cancelInvitation: '取消邀请',
    noTeam: '该账号没有团队信息',
    canStillInvite: '但您仍然可以发送邀请',
    loadFailed: '加载团队信息失败',
    inviteSuccess: '邀请成功',
    inviteFailed: '邀请失败',
    removeSuccess: '移除成功',
    ...
    cancelFailed: '取消邀请失败',
    confirmRemove: '确定要移除成员 {email} 吗？',
    confirmCancel: '确定要取消对 {email} 的邀请吗？',
    refreshSession: '刷新 Session',
    refreshing: '刷新中...',
    refreshSuccess: 'Session 刷新成功',
    refreshFailed: 'Session 刷新失败',
    sessionExpired: 'Session 已过期,请刷新',
    checkingSession: '检查 Session...',
    sessionValid: 'Session 有效',
    sessionInvalid: 'Session 已失效'
  }
}
